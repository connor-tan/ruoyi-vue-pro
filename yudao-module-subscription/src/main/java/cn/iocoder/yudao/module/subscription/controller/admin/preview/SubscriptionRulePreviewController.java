...
import cn.iocoder.yudao.module.subscription.controller.admin.preview.vo.SubscriptionRulePreviewReqVO;
...
public class SubscriptionRulePreviewController {
    ...
    @Operation(summary = "预览某个学生在某个窗口下的可见刊物")
    @PreAuthorize("@ss.hasPermission('subscription:preview:query')")
    public CommonResult<SubscriptionRulePreviewRespVO> preview(@Valid @RequestBody SubscriptionRulePreviewReqVO reqVO) {
