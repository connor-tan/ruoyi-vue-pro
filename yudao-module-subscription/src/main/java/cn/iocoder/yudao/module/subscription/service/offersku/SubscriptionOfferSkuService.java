...
@Service
@Validated
public class SubscriptionOfferSkuService {
    ...
    public int syncMatchedOfferSkus(Long offerId) {
        ...
        if (CollUtil.isEmpty(insertList)) {
            offerSkuAvailabilityService.validateEnabledOfferHasEffectiveSku(offerId);
            return 0;
        }
    ...
    public void batchUpdate(SubscriptionOfferSkuBatchUpdateReqVO reqVO) {
        ...
        offerSkuAvailabilityService.validateEnabledOfferHasEffectiveSku(reqVO.getOfferId());
    }
    ...
    public void deleteOfferSku(Long id) {
        ...
        offerSkuAvailabilityService.validateEnabledOfferHasEffectiveSku(offerSku.getOfferId());
    }
