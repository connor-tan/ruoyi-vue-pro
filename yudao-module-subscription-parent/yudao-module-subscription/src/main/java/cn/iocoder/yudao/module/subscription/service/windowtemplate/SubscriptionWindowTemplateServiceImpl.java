...
public class SubscriptionWindowTemplateServiceImpl implements SubscriptionWindowTemplateService {
    ...
    public Long createWindowTemplate(SubscriptionWindowTemplateSaveReqVO createReqVO) {
        ...
        template.setCode(generateTemplateCode());
        template.setBuiltIn(Boolean.FALSE);
        template.setGradeResolveMode(normalizeGradeResolveMode(template.getGradeResolveMode()));
    ...
    public void updateWindowTemplate(SubscriptionWindowTemplateSaveReqVO updateReqVO) {
        ...
        if (Boolean.TRUE.equals(oldTemplate.getBuiltIn())
                ...
                || !Objects.equals(normalizeGradeResolveMode(oldTemplate.getGradeResolveMode()),
                normalizeGradeResolveMode(updateReqVO.getGradeResolveMode())))) {
        ...
        updateObj.setCode(oldTemplate.getCode());
        updateObj.setBuiltIn(oldTemplate.getBuiltIn());
        updateObj.setGradeResolveMode(normalizeGradeResolveMode(updateObj.getGradeResolveMode()));
    ...
    private String generateTemplateCode() {
        String code;
        do {
            code = "WINDOW_TEMPLATE_" + IdUtil.fastSimpleUUID();
        } while (subscriptionWindowTemplateMapper.countByCode(code, null) > 0);
        return code;
    }
