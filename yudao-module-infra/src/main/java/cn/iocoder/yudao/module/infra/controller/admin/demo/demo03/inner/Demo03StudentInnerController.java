...
public class Demo03StudentInnerController {
    ...
    public CommonResult<List<Demo03CourseRespVO>> getDemo03CourseListByStudentId(@RequestParam("studentId") Long studentId) {
        return success(BeanUtils.toBean(demo03StudentInnerService.getDemo03CourseListByStudentId(studentId),
    ...
    public CommonResult<Demo03GradeRespVO> getDemo03GradeByStudentId(@RequestParam("studentId") Long studentId) {
        return success(BeanUtils.toBean(demo03StudentInnerService.getDemo03GradeByStudentId(studentId),
