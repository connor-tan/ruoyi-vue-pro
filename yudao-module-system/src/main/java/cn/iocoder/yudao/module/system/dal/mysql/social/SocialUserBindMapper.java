...
public interface SocialUserBindMapper extends BaseMapperX<SocialUserBindDO> {
    ...
    default int deleteByUserTypeAndUserIdAndSocialType(Integer userType, Long userId, Integer socialType) {
        return delete(new LambdaQueryWrapperX<SocialUserBindDO>()
                .eq(SocialUserBindDO::getUserType, userType)
                .eq(SocialUserBindDO::getUserId, userId)
                .eq(SocialUserBindDO::getSocialType, socialType));
    }

    default int deleteByUserTypeAndSocialUserId(Integer userType, Long socialUserId) {
        return delete(new LambdaQueryWrapperX<SocialUserBindDO>()
                .eq(SocialUserBindDO::getUserType, userType)
