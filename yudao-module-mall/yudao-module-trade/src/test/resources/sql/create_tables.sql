...
(
    ...
    "order_source"            varchar  NOT NULL DEFAULT 'APP',
    "user_id"                 bigint,
...
(
    ...
    "warehouse_name_snapshot"  varchar  NULL,
    "window_id"              bigint   NULL,
    "window_name_snapshot"   varchar  NULL,
    "offer_id"               bigint   NULL,
    "offer_sku_id"           bigint   NULL,
    "issue_id"               bigint   NULL,
    "issue_no"               int      NULL,
    "issue_name"             varchar  NULL,
    "planned_publish_date"   date     NULL,
    "planned_delivery_date"  date     NULL,
    "delivery_status"        int      NOT NULL,
    "receive_status"         int      NOT NULL,
    "canceled"               bit      NOT NULL DEFAULT FALSE,
    "delivery_batch_id"      bigint   NULL,
    "delivery_time"          datetime NULL,
    "logistics_id"           bigint   NULL,
    "logistics_no"           varchar  NULL,
