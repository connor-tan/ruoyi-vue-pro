...
(
    ...
    "subscription_window_sku_id" bigint NULL,
    "creator" varchar DEFAULT '',
    "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar DEFAULT '',
    "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(
    ...
    "receiver_detail_address"  varchar,
    "school_id"                bigint,
    "school_name_snapshot"     varchar,
    "station_id"               bigint,
    "station_name_snapshot"    varchar,
    "station_address_snapshot" varchar,
...
(
    ...
    "subscription_student_id" bigint NULL,
    "subscription_student_name_snapshot" varchar NULL,
    "subscription_school_id" bigint NULL,
    "subscription_school_name_snapshot" varchar NULL,
    "subscription_class_id" bigint NULL,
    "subscription_class_name_snapshot" varchar NULL,
    "subscription_grade_catalog_id" bigint NULL,
    "subscription_grade_name_snapshot" varchar NULL,
    "subscription_window_id" bigint NULL,
    "subscription_window_name_snapshot" varchar NULL,
    "subscription_target_year_start" int NULL,
    "subscription_target_year_end" int NULL,
    "subscription_target_period" varchar NULL,
    "subscription_window_spu_id" bigint NULL,
    "subscription_window_sku_id" bigint NULL,
    "subscription_visibility_reason" varchar NULL,
    "subscription_matched_rule_id" bigint NULL,
    "subscription_grade_applicability_override" boolean NULL,
    "creator"           varchar           DEFAULT '',
    "create_time"       datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater"           varchar           DEFAULT '',
    "update_time"       datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
