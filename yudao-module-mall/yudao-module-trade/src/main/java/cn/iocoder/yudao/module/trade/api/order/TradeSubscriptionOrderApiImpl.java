...
public class TradeSubscriptionOrderApiImpl implements TradeSubscriptionOrderApi {
    ...
    public boolean hasPublicationOrderReferenceByProductSpuId(Long productSpuId) {
        return tradeOrderQueryService.hasPublicationOrderReferenceByProductSpuId(productSpuId);
    }

    @Override
    public Set<Long> getPublicationOrderReferencedProductSkuIds(Collection<Long> productSkuIds) {
        return tradeOrderQueryService.getPublicationOrderReferencedProductSkuIds(productSkuIds);
    }
